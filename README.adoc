...
// todo Add license.
// todo Document Caddy configuration for exposing electrs over port 500002
...
[,sh]
----
cp ~/Projects/bitcoin-core-config/systemd/user/* ~/.config/systemd/user/
----

[,sh]
----
systemctl --user enable --now remove-bitcoin-onion-private-key.timer
Created symlink /var/home/core/.config/systemd/user/timers.target.wants/remove-bitcoin-onion-private-key.timer → /var/home/core/.config/systemd/user/remove-bitcoin-onion-private-key.timer.
----
